...
public class EventListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private ArrayList<Event> stories = new ArrayList<>();

    public EventListAdapter(AppCompatActivity activity, ArrayList<Event> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (stories.get(position).getDescription() != null)
            viewHolder.description.setText(Html.fromHtml(stories.get(position).getDescription()));
        else
